...
- Then just paste in the yaml file again, no need to remove any of the # comment lines except everything before "fields:". This must be the first line in the input field or else the import wont work.
